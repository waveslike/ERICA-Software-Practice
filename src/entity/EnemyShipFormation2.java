 ...
 *
 */
public class EnemyShipFormation2 implements Iterable<EnemyShip2> {
    ...
    private static final double SHOOTING_VARIANCE = 1.5;
    ...
    private List<List<EnemyShip2>> enemyShips;
    ...
    private List<EnemyShip2> shooters;
     ...
     */
    public EnemyShipFormation2(final GameSettings gameSettings) {
        this.drawManager = Core.getDrawManager();
        this.logger = Core.getLogger();
        this.enemyShips = new ArrayList<List<EnemyShip2>>();
        ...
        this.shooters = new ArrayList<EnemyShip2>();
        ...
        for (int i = 0; i < this.nShipsWide; i++)
            this.enemyShips.add(new ArrayList<EnemyShip2>());

        for (List<EnemyShip2> column : this.enemyShips) {
            for (int i = 0; i < this.nShipsHigh; i++) {
                ...
                column.add(new EnemyShip2((SEPARATION_DISTANCE
    ...
    public final void draw() {
        for (List<EnemyShip2> column : this.enemyShips)
            for (EnemyShip2 enemyShip : column)
    ...
    public final void update() {
        ...
        if (movementInterval >= this.movementSpeed) {
            ...
            // Cleans explosions.
            List<EnemyShip2> destroyed;
            for (List<EnemyShip2> column : this.enemyShips) {
                destroyed = new ArrayList<EnemyShip2>();
                for (EnemyShip2 ship : column) {
    ...
    public final void shoot(final Set<Bullet> bullets) {
        ...
        EnemyShip2 shooter = this.shooters.get(index);
     ...
     */
    public final void destroy(final EnemyShip2 destroyedShip) {
        for (List<EnemyShip2> column : this.enemyShips)
        ...
        if (this.shooters.contains(destroyedShip)) {
            ...
            EnemyShip2 nextShooter = getNextShooter(this.enemyShips
     ...
     */
    public final EnemyShip2 getNextShooter(final List<EnemyShip2> column) {
        Iterator<EnemyShip2> iterator = column.iterator();
        EnemyShip2 nextShooter = null;
        while (iterator.hasNext()) {
            EnemyShip2 checkShip = iterator.next();
     ...
     */
    @Override
    public final Iterator<EnemyShip2> iterator() {
        Set<EnemyShip2> enemyShipsList = new HashSet<EnemyShip2>();
