 ...
 *
 */
public class EnemyShipFormation3 implements Iterable<EnemyShip3> {
    ...
    private static final double SHOOTING_VARIANCE = 2.5;
    ...
    private List<List<EnemyShip3>> enemyShips;
    ...
    private List<EnemyShip3> shooters;
     ...
     */
    public EnemyShipFormation3(final GameSettings gameSettings) {
        this.drawManager = Core.getDrawManager();
        this.logger = Core.getLogger();
        this.enemyShips = new ArrayList<List<EnemyShip3>>();
        ...
        this.shooters = new ArrayList<EnemyShip3>();
        ...
        for (int i = 0; i < this.nShipsWide; i++)
            this.enemyShips.add(new ArrayList<EnemyShip3>());

        for (List<EnemyShip3> column : this.enemyShips) {
            for (int i = 0; i < this.nShipsHigh; i++) {
                ...
                column.add(new EnemyShip3((SEPARATION_DISTANCE
    ...
    public final void draw() {
        for (List<EnemyShip3> column : this.enemyShips)
            for (EnemyShip3 enemyShip : column)
    ...
    public final void update() {
        ...
        if (movementInterval >= this.movementSpeed) {
            ...
            // Cleans explosions.
            List<EnemyShip3> destroyed;
            for (List<EnemyShip3> column : this.enemyShips) {
                destroyed = new ArrayList<EnemyShip3>();
                for (EnemyShip3 ship : column) {
    ...
    public final void shoot(final Set<Bullet> bullets) {
        ...
        EnemyShip3 shooter = this.shooters.get(index);
     ...
     */
    public final void destroy(final EnemyShip3 destroyedShip) {
        for (List<EnemyShip3> column : this.enemyShips)
        ...
        if (this.shooters.contains(destroyedShip)) {
            ...
            EnemyShip3 nextShooter = getNextShooter(this.enemyShips
     ...
     */
    public final EnemyShip3 getNextShooter(final List<EnemyShip3> column) {
        Iterator<EnemyShip3> iterator = column.iterator();
        EnemyShip3 nextShooter = null;
        while (iterator.hasNext()) {
            EnemyShip3 checkShip = iterator.next();
     ...
     */
    @Override
    public final Iterator<EnemyShip3> iterator() {
        Set<EnemyShip3> enemyShipsList = new HashSet<EnemyShip3>();
